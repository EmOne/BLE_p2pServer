...
typedef enum
{
  ...
  CFG_TASK_SW3_BUTTON_PUSHED_ID,
	CFG_TASK_MODULE_CURRENT_RAMP_ID,
	CFG_TASK_MODULE_CURRENT_STEP_ID,
	CFG_TASK_MODULE_CURRENT_PCT_ID,
	CFG_TASK_MODULE_CURRENT_PROCESS_ID,
	CFG_TASK_MODULE_CURRENT_STOP_ID,
