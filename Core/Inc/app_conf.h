...
typedef enum
{
  ...
  CFG_TASK_SW3_BUTTON_PUSHED_ID,
	CFG_TASK_MODULE_CURRENT_SINK_OFF_ID,
	CFG_TASK_MODULE_CURRENT_SINK_ON_ID,
	CFG_TASK_MODULE_CURRENT_SOURCE_OFF_ID,
	CFG_TASK_MODULE_CURRENT_SOURCE_RAMP_ID,
	CFG_TASK_MODULE_CURRENT_SOURCE_STEP_ID,
	CFG_TASK_MODULE_CURRENT_SOURCE_PCT_ID,
	CFG_TASK_MODULE_VOLTAGE_SINK_OFF_ID,
	CFG_TASK_MODULE_VOLTAGE_SINK_ON_ID,
	CFG_TASK_MODULE_VIBRATE_SINK_OFF_ID,
	CFG_TASK_MODULE_VIBRATE_SINK_ON_ID,
	CFG_TASK_MODULE_TEMPERATURE_SINK_OFF_ID,
	CFG_TASK_MODULE_TEMPERATURE_SINK_ON_ID,
